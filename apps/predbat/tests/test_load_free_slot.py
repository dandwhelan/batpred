...
def test_load_free_slot(my_predbat):
    ...
    rate_replicate = {}
    my_predbat.load_free_slot(mixed_slots, my_predbat.rate_import, export=False, rate_replicate=rate_replicate)
    ...
    rate_replicate = {}
    my_predbat.load_free_slot(late_slot, my_predbat.rate_import, export=False, rate_replicate=rate_replicate)
